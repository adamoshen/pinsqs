...
If a value for `nthreads` is not supplied to
[`pin_qread()`](https://adamoshen.github.io/pinsqs/reference/read-write.md)
or
[`pin_qwrite()`](https://adamoshen.github.io/pinsqs/reference/read-write.md),
it will default to `parallel::detectCores() / 2`. Otherwise, if
[`parallel::detectCores()`](https://rdrr.io/r/parallel/detectCores.html)
is `NA`, it will fallback to the default of the
[qs](https://github.com/qsbase/qs) package, which is 1.
